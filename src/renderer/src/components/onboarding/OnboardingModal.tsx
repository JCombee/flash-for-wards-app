...
export function OnboardingModal() {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50">
      <div className="bg-lol-dark-mid border border-lol-gold/40 rounded-lg p-8 max-w-lg w-full mx-4 max-h-[90vh] overflow-y-auto">
              ...
              {lcuPages && lcuPages.length > 0 && (
                <div className="mt-3">
                  ...
                  <button
                    ...
                    className="mt-3 px-4 py-2 bg-green-600 hover:bg-green-500 text-white font-semibold rounded text-sm disabled:opacity-40 transition-colors"
                  >
                    Use selected page →
                  </button>
                </div>
